...
| 指标 | 当前结果 | 判定 |
|---|---:|---|
| C++ 编译器单元测试 | 235 / 235 | ✅ 本轮实机 |
| 本机开发 CTest 项目门禁 | 11 / 11（单元、CLI、addon、架构、发行打包与官方项目语料） | ✅ 本轮实机 |
| 最低系统构建契约 | Windows 10、macOS 11.0（arm64）、Ubuntu 22.04/glibc 2.35、Android 9/API 28、iOS 16.0；Web 无固定版本下限；编译参数、SDK schema 4 清单、导出预设与 CI 使用同一基线 | ✅ 规则与失败关闭测试 |
